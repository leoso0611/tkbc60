  ...
  const copyrightarea = () => {
    return (
      <div className="bg-secondary">
        <div className="max-w-screen-xl mx-auto p-6 md:p-4 text-xs text-copyrighttext font-medium">
  ...
  const contactarea = () => {
    return (
      <div className="bg-primary">
        <div className="max-w-screen-xl mx-auto p-6 md:p-4 text-xs text-secondary font-medium flex flex-col gap-y-2">
